/**
 * @module animation
 * @description Портирование блока Animation из bem-contrib/bem-animations
 */

modules.define('animation',
    ['i-bem__dom'],
 ...
 * @bem
 */
provide(bemDom.decl(this.name, /** @lends animation.prototype */ {
     ...
     */
    reset : function() {
        for(const mod of Object.keys(this._modCache)) {
            if(mod === 'js') {
                continue;
            }
            this.delMod(mod);
    ...
    */
    ...
    live : function() {
        ...
        this
            .liveBindTo(ptp._prefixed('AnimationEnd'), ptp._onEnd)
            .liveBindTo(ptp._prefixed('AnimationStart'), ptp._onStart)
            .liveBindTo(ptp._prefixed('AnimationIteration'), ptp._onIteration);
